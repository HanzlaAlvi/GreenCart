...
import { addReview, getReviews, clearReviewError } from "@/store/shop/review-slice";
...
function ProductDetailsDialog({ open, setOpen, productDetails }) {
  ...
  const { reviews, isSubmitting } = useSelector((state) => state.shopReview);
  ...
  const handleAddReview = async () => {
    if (!reviewMsg.trim()) {
      toast({
        title: "Review message cannot be empty",
        variant: "destructive",
      });
      return;
    }
