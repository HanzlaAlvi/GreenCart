...
function AddressCard({
  ...
  return (
    ...
    >
      ...
      <Card
        onClick={() => !isEditing && setCurrentSelectedAddress?.(addressInfo)}
          ...
          >
            ...
            <div className="space-y-2">
              ...
              >
                ...
                {addressInfo?.notes && (
                  <motion.p className="text-gray-500 flex items-start gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
        ...
        <CardFooter className="p-4 pt-0 flex justify-end gap-2">
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              ...
              disabled={isEditing}
            >
              {isEditing && addressInfo?._id === selectedId?._id ? "Editing..." : "Edit"}
            </Button>
          </motion.div>
