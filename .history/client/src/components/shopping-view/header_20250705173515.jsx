      ...
      {shoppingViewHeaderMenuItems.map((menuItem) => (
        ...
        >
          <Label
            ...
            className={cn(
              "text-sm font-medium cursor-pointer px-3 py-2 rounded-md transition-colors",
              location.pathname === menuItem.path
                ? "bg-[#A7BC8A] text-white"
                : "text-gray-700 hover:bg-[#D1E2C4] hover:text-gray-900"
            )}
          >
            {menuItem.label}
          </Label>
    ...
    <div className="flex items-center gap-4">
      ...
      <Sheet open={openCartSheet} onOpenChange={() => setOpenCartSheet(false)}>
        <motion.div whileHover={{ scale: 1.05 }}>
          <Button
            ...
            variant="ghost"
            size="icon"
            className="relative hover:bg-[#D1E2C4]"
          >
            <ShoppingCart className="w-5 h-5 text-[#5E8B4F]" />
            {cartItems?.items?.length > 0 && (
              <span className="absolute top-0 right-0 bg-[#A7BC8A] text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <motion.div whileHover={{ scale: 1.05 }}>
            <Avatar className="border border-[#A7BC8A]">
        ...
        <DropdownMenuContent 
          side="bottom" 
          className="w-56 mt-2 shadow-xl rounded-lg border border-[#D1E2C4]"
        >
          ...
          <DropdownMenuItem 
            ...
            className="cursor-pointer hover:bg-[#D1E2C4]/50"
          >
  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        "bg-white border-b border-[#D1E2C4]",
        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <Link to="/shop/home" className="flex items-center gap-2">
              <HousePlug className="h-6 w-6 text-[#A7BC8A]" />
          ...
          <div className="lg:hidden">
            <Sheet>
              ...
              <SheetContent 
                side="right" 
                className="w-[300px] sm:w-[350px] border-l border-[#D1E2C4]"
              >
