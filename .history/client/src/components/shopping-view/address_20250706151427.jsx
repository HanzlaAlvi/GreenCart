...
function Address({ setCurrentSelectedAddress, selectedId }) {
  ...
  return (
    ...
    >
      <Card className="border-[#A7BC8A]/30">
        <CardHeader className="bg-[#FAF9F6] rounded-t-lg border-b border-[#A7BC8A]/20">
          <CardTitle className="text-[#5E8B4F]">
        ...
        <CardContent className="p-6">
          ...
          >
            <CommonForm
              ...
              buttonClassName="bg-[#5E8B4F] hover:bg-[#4A7740]"
            />
          </motion.div>
        </CardContent>
      </Card>
