...
function ShoppingCheckout() {
  ...
  const validateOrderData = (data) => {
    const requiredFields = [
      ...
      'paymentMethod', 'subtotal', 'shippingFee', 'totalAmount'
    ];
    ...
    try {
      const orderData = {
        ...
        addressInfo: {
          ...
          notes: currentSelectedAddress.notes || '' // Ensure notes is never undefined
        },
        paymentMethod: 'cod',
      ...
      if (result.success) {
        ...
        throw new Error(result.message || "Order failed without error message");
      }
    } catch (error) {
