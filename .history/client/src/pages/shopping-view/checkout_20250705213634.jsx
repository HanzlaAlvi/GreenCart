...
import { Sparkles, ShoppingBag, CreditCard, Loader2, Smartphone, Wallet } from "lucide-react";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t border-[#A7BC8A]/20">
                    ...
                    >
                      <Button
                        ...
                        onClick={() => {
                          ...
                          if (option.id === 'cod' || option.id === 'paypal') {
                            handlePaymentSelection(option.id);
                          }
                        }}
                        className={cn(
                      ...
                      {expandedPayment === option.id && (
                        ...
                        >
                          <div className="p-3 text-sm bg-[#FAF9F6] rounded-md border border-[#A7BC8A]/20">
                            ...
                            {(option.id === 'jazzcash' || option.id === 'easypaisa') && (
                              <div className="mt-2">
                                <Button
                                  onClick={() => handlePaymentSelection(option.id)}
                                  className="w-full bg-[#5E8B4F] hover:bg-[#4A7740]"
                                >
                                  Confirm Payment
                                </Button>
                              </div>
              ...
              {/* Checkout Button for JazzCash/EasyPaisa */}
