...
function ShoppingCheckout() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50"> {/* Added bg-gray-50 for light gray background */}
      {/* Hero Banner */}
      <motion.div 
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="bg-white rounded-xl shadow-lg border border-[#A7BC8A]/20 p-6" // Added white background
          >
